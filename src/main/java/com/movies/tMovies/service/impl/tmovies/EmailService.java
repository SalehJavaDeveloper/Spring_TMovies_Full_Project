...
@Autowired
    ...
    public String getSubject(){
        String body = "<html><head></head><body>Welcome to TMovies. We hope you will enjoy our site. Please confirm login authentication. <a href=\"http://localhost:9095/tmovies/payment/information\">Click to login</a></body></html>";
        return body;
    }
}
